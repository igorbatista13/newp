                        ...
                        <tr>
                           ...
                           <td>
                            ...
                            Imprimir Contrato
                               ...
                               <!-- Butão de deletar -->
                               <td>          
                              <a class="btn btn-warning text-light" href="{{ route('contrato.edit',$contratos->id) }}">Editar</a>
                  
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{ $contratos->id }}">
                                 
                                  <i class="now-ui-icons ui-1_simple-remove"></i>  Deletar
                                </button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal{{ $contratos->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <td> <a class="btn btn-success text-light" target=_blank href="https://wa.me/+55{{$contratos->empresa_cliente->Telefone ?? 'Telefone'}}">
