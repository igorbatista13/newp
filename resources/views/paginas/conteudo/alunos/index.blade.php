                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://clipart-library.com/image_gallery/n1043230.png" class="avatar avatar-sm me-3" alt="avatar image">
    ...
    <div class="col-xl-5 ms-auto mt-xl-0 mt-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6 mt-md-0 mt-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h1 class="text-gradient text-primary"> <span id="status2" countto="5">5</span>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        <h1 class="text-gradient text-primary"><span id="status3" countto="10">10</span>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h1 class="text-gradient text-primary"><span id="status4" countto="417">417</span>
                            <span class="text-lg ms-n2">GB</span>
                        </h1>
