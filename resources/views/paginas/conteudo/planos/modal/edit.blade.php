...
<button class="btn btn-icon btn-outline-dark ms-2 export" data-bs-toggle="modal" data-bs-target="#EditPlanos_{{ $planos->id }}"
    type="button">
...
<div class="modal fade" id="EditPlanos_{{ $planos->id }}" tabindex="-1" aria-labelledby="EditPlanos_{{ $planos->id }}" aria-hidden="true">
