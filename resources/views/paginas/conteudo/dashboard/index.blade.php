                ...
                <div class="col-sm-4">
                    <div class="card overflow-hidden">
                        <div class="card-header p-3 pb-0">
                            ...
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Contas a Receber</p>
                ...
                <div class="col-sm-4 mt-sm-0 mt-4">
                    <div class="card overflow-hidden">
                        <div class="card-header p-3 pb-0">
                            ...
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Contas a pagar</p>
                            <h5 class="font-weight-bolder mb-0 text-danger">
                                R$130,832
                                {{-- <span class="text-danger text-sm font-weight-bolder">-20%</span> --}}
                            </h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="chart">
